...
<head>
    ...
    <link href="{{ asset('dashboard/css/boostrap.min.css') }}/css/styles.css" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="experience">
            <div class="resume-section-content">
                <h2 class="mb-5">Gabriel Ryu Ferdinand</h2>
        ...
        <section class="resume-section" id="education">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">St. Albertus High School</h3>
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('dashboard/js/boostrap.bundle.min.js') }}/js/scripts.js"></script>
</body>
